...
- [ ] non logged in app ready trigger + UI to log in.
- [ ] prompt input needs: - full component rethink - full data flow rethink - better performances - find workaround for clean persistence between chat session while being bounded to active chat session states
